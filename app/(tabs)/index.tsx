  ...
  return (
    <View className="flex h-full flex-row items-center justify-center">
      <View className="flex h-full flex-col items-center justify-center">
        <TextInput
          className="text-start text-3xl text-black dark:text-white"
          multiline={false}
          value={calculatorViewModel.input}
          editable={false}
        />
        <View className="flex flex-row items-center gap-1">
          <View>
            ...
            <Button
              ...
              title="7"
              onPress={() => buttonViewModel.handleButtonPress('7')}
            />
            <Button
              className="rounded-full"
              title="4"
              onPress={() => buttonViewModel.handleButtonPress('4')}
            />
            <Button
              className="rounded-full"
              title="1"
              onPress={() => buttonViewModel.handleButtonPress('1')}
            />
            <Button
              className="rounded-full"
              title={<Ionicons name="calculator" size={25} />}
              onPress={() => navigation.navigate('List' as never)}
            />
          </View>
          <View>
            <Button
              title={<FontAwesome6 name="delete-left" size={25} />}
              onPress={buttonViewModel.undo}
            />
